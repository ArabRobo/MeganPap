...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6777016039:AAGjShpFLx9uMUrnOA-VPXsou7fuEPps9eU")
...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002114235593"))
...
FORCE_SUB_GROUP = int(os.environ.get("FORCE_SUB_GROUP", "-1001651360411"))

# Tulisan joinnya mau gimana
BUTTONS_JOIN_TEXT = os.environ.get("BUTTONS_JOIN_TEXT", "Join CH")
BUTTONS_JOIN_TEXT2 = os.environ.get("BUTTONS_JOIN_TEXT2", "JOIN GC")
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "5478238614 6240078955 6475339841").split())]
except ValueError:
